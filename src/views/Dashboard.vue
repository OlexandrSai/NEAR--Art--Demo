            ...
            <div class="flex">
                ...
                <div class="lg:ml-10 w-full">
                    <nav>
                        ...
                        <form action=""
                            class="mt-7 lg:mt-0 flex flex-col md:flex-row items-center justify-between w-full">
                    ...
                    <div v-if="generatedDesign != null"
                        ...
                        <div class="relative flex flex-col md:flex-row items-start md:items-end mt-9">
                            ...
                            <img src="@/assets/img/romb.png" alt=""
                                class="hidden md:block lg:hidden absolute w-16 top-0 right-24">
                            <img src="@/assets/img/black.png" alt=""
                                class="hidden md:block absolute w-16 lg:w-24 -top-4 right-0">
                    ...
                    <div class="relative mt-8 ownart-bg h-auto px-5 md:px-20 lg:px-16 xl:px-8 2xl:px-10 pt-9 pb-12">
                        ...
                        <img src="@/assets/img/square.png" alt=""
                            class="hidden md:block lg:hidden w-24 absolute top-6 -left-12">
                        <img src="@/assets/img/vector.png" alt=""
                            class="hidden md:block absolute w-24 -bottom-12 right-0">
                                    ...
                                    <div class="w-full h-8 bg-gray-900 rounded-t-xl">
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="grid grid-flow-row text-gray-500 text-sm m-3 md:m-4">
                                                <div class="pb-1 ">
                                                    <p class="text-green-400">.about <span
                                                            class="text-gray-500">{</span></p>
                                                </div>
